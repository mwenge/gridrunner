...
; ---------------------------------------------------------------------------
                ...
                move.b  #0,($FF8260).l  ; Move Data from Source to Destination
...
loc_125D2:                              ; CODE XREF: ROM:000125D8↓j
                ...
                jsr     sub_1283A       ; Jump to Subroutine
...
sub_1276A:                              ; CODE XREF: ROM:000126C8↑p
                                        ; sub_12998+34↓p
...
; ---------------------------------------------------------------------------
byte_127BE:     dc.b   7,  0,  4,  7,  0,  7,  7,$30
                                        ; DATA XREF: sub_1276A+C↑o
byte_127C6:     dc.b   2,  6,$64,  4,  3, $F,$64,  2
                                        ; DATA XREF: sub_1276A+1E↑o
                dc.b   4,  3,$32,  2,  4, $A,$46,  3
; ---------------------------------------------------------------------------
...
sub_127F4:                              ; CODE XREF: ROM:0001266C↑p
                                        ; ROM:000126E0↑p
...
sub_1284C:                              ; CODE XREF: ROM:00012E5C↓p
...
sub_12936:                              ; CODE XREF: sub_1284C+BC↑p
                                        ; sub_1284C+C0↑p ...
...
sub_12978:                              ; DATA XREF: ROM:00012632↑o
...
sub_12998:                              ; DATA XREF: ROM:00012748↑o
...
sub_12C96:                              ; CODE XREF: sub_12998+1B8↑p
                                        ; ROM:000131C6↓j
...
sub_12CC6:                              ; CODE XREF: sub_12998+1A6↑p
...
loc_12CE2:                              ; CODE XREF: sub_12CC6+14↑j
                ...
                rts                     ; Return from Subroutine
; End of function sub_12CC6


; =============== S U B R O U T I N E =======================================


sub_12CF0:                              ; DATA XREF: ROM:00012618↑o
                btst    #1,($1577E).l   ; Test a Bit
...
sub_12D72:                              ; CODE XREF: sub_127F4+28↑p
                                        ; sub_1284C+22↑p ...
...
sub_12E24:                              ; CODE XREF: sub_127F4+40↑p
...
sub_12E44:                              ; CODE XREF: sub_127F4+6↑p
                move.w  #$1F3F,d0       ; Move Data from Source to Destination
...
loc_12E48:                              ; CODE XREF: sub_12E44+6↓j
                ...
                rts                     ; Return from Subroutine
; End of function sub_12E44

; ---------------------------------------------------------------------------

loc_12E50:                              ; CODE XREF: ROM:loc_12752↑p
                                        ; ROM:loc_127D6↑p
...
loc_12EAC:                              ; CODE XREF: ROM:00012EDA↓j
...
; ---------------------------------------------------------------------------
byte_12F08:     dc.b $4E                ; DATA XREF: ROM:000125B0↑o
                dc.b $75 ; u
; ---------------------------------------------------------------------------
...
sub_12FAA:                              ; CODE XREF: ROM:00013100↓p
                                        ; ROM:000131BA↓p
...
sub_12FDA:                              ; CODE XREF: ROM:0001270C↑p
                                        ; ROM:0001271E↑p ...
...
sub_12FF0:                              ; CODE XREF: sub_12998:loc_12ADA↑p
                lea     ($15784).l,a0   ; Load Effective Address
...
sub_1301E:                              ; CODE XREF: sub_1284C↑p
...
sub_13082:                              ; CODE XREF: sub_12998:loc_12B24↑p
                                        ; sub_1309E+14↓p
                btst    #1,($1577E).l   ; Test a Bit
                bne.w   locret_12FEE    ; Branch if Not Equal
                clr.w   ($1577C).l      ; Clear an Operand
...
sub_1309E:                              ; CODE XREF: ROM:00013054↑p
                                        ; ROM:000130C0↓p ...
                bsr.w   sub_13156       ; Branch to Subroutine
...
sub_13156:                              ; CODE XREF: sub_12C96+26↑p
                                        ; sub_1309E↑p ...
...
sub_13178:                              ; CODE XREF: sub_12998+98↑p
                                        ; sub_12998+B6↑p ...
...
loc_13230:                              ; CODE XREF: ROM:00013208↑j
                ...
                bra.w   loc_1314E       ; Branch Always
; ---------------------------------------------------------------------------
byte_13242:     dc.b   0,  1,$30,$C0,  0,  1,$30,$54
                                        ; DATA XREF: sub_12FF0:loc_13008↑o
                dc.b   0,  1,$31,$92
byte_1324E:     dc.b   3,  0,  3,  0,  3,  0,$FF,$FF
                                        ; DATA XREF: sub_127F4+A↑o
                dc.b   3,  0,  3,  0,  3,  0,  3,  0
                dc.b   1,  0,  3,$80,  7,$C0, $F,$E0
                dc.b $53,$94,$47,$C4,$6F,$EC,$7F,$FC
                dc.b   3,  0,  7,$80,  7,$80,  3,  0
                dc.b   3,  0,  3,  0,  3,  0,  3,  0
                dc.b   3,$F8,  0, $E,$3F,$F3,$FC,$FF
                dc.b $FF,$3F,$CF,$FC,$70,  0,$1F,$C0
                dc.b   1,$F8,  6,$7C,$19,$FC,  7,$38
                dc.b $1C,$E0,$3F,$98,$3F,$60,$1F,$80
                dc.b  $F,$C0,$1B,$E0,$1B,$28,$1B,$EC
                dc.b  $A,$6C,  3,$EC,  3,$F8,  1,$C0
                dc.b $1F,$80,$3E,$60,$3F,$98,$1C,$E0
                dc.b   7,$38,$19,$FC,  6,$FC,  1,$F8
                dc.b $3F,$FC,  0, $C,$30,$3C,$30,$CC
                dc.b $33, $C,$3C, $C,$3F,$FC,  0,  0
                dc.b  $F,  0,  0,  0,  3,  0,  3,  0
                dc.b   3,  0,  3,  0, $F,$C0,  0,  0
                dc.b $3F,$FC,  0, $C,  0, $C,$1F,$FC
                dc.b $18,  0,$18,  6,$1F,$FE,  0,  0
                dc.b $3F,$FC,  0, $C,  0, $C,  3,$FC
                dc.b   0, $C,$30, $C,$3F,$FC,  0,  0
                dc.b $18,  0,  0,$C0,$38,$C0,$3F,$F8
                dc.b   0,$C0,  0,$C0,  0,$C0,  0,  0
                dc.b $3F,$FE,  0,  6,$30,  0,$3F,$F8
                dc.b   0, $C,$60, $C,$7F,$F8,  0,  0
                dc.b $1F,$F8,  0, $C,$30,  0,$3F,$F8
                dc.b $30, $C,$30, $C,$1F,$F8,  0,  0
                dc.b $3F,$FC,$30, $C,  0,$30,  0,$C0
                dc.b   3,  0,  3,  0,  3,  0,  0,  0
                dc.b $1F,$F8,  0, $C,$30, $C,$1F,$F8
                dc.b $30, $C,$30, $C,$1F,$F8,  0,  0
                dc.b $1F,$F8,  0, $C,$30, $C,$1F,$FC
                dc.b   0, $C,$70, $C,$3F,$F8,  0,  0
                dc.b   0,  7,$FF,$80,$34,  0,$4F,$E0
                dc.b $13,$BF,$13,$BF,$4F,$E0,$34,  0
                dc.b $FF,$C0,  1,$80,$11,$88,  3,$C0
                dc.b $16,$68,$3F,$FC,$2D,$B4,$38,$1C
                dc.b $10,  8,  0,  0,  6,  0,$87, $C
                dc.b $CD,$9F,$68,$F3,$38,$60,$10,  0
                dc.b   0,  0,  1,$80,  7,  0, $E,  0
                dc.b   3,$C0,  0,$70,  0,$1C,  0,$30
                dc.b   0,$E0,  0,  0,  0,  0,  0,  0
                dc.b   1,$80,  1,$80,  0,  0,  0,  0
                dc.b   0,  0,  0,  0,  1,$80,  3,$C0
                dc.b   7,$E0,  7,$E0,  3,$C0,  1,$80
                dc.b   0,  0,  8,$10,  5,$A0,  2,$40
                dc.b   7,$E0,  7,$E0,  2,$40,  5,$A0
                dc.b   8,$10,  9,$90,  6,$60,  6,$60
                dc.b   9,$90,  9,$90,  6,$60,  6,$60
                dc.b   9,$90
byte_133E0:     dc.b $10,  8,$18,$18,$1D,$B8,$17,$E8
                                        ; DATA XREF: ROM:00013138↑o
                dc.b   2,$C0,  3,$C0,  2,$C0,  1,$80
byte_133F0:     dc.b $30,  6,  0,$30,$63,  0,  0, $C
                                        ; DATA XREF: sub_1284C+B4↑o
                dc.b $31,$80,  0,$30,$CC,  3,  0,$C0
byte_13400:     dc.b   1,  0,  1,  1    ; DATA XREF: ROM:0001261E↑o
byte_13404:     dc.b   4,$16, $B,$B8    ; DATA XREF: ROM:0001269E↑w
                                        ; sub_12998↑w ...
byte_13408:     dc.b   0,  1,$37,$60    ; DATA XREF: ROM:00012640↑r
                                        ; ROM:00012E56↑r ...
byte_1340C:     dc.b   0,  1,$47,$60    ; DATA XREF: ROM:0001264C↑r
                                        ; ROM:00012EA6↑r ...
byte_13410:     dc.b   0, $E,  0,$85    ; DATA XREF: sub_1284C+40↑r
                                        ; sub_12998+1D8↑r ...
byte_13414:     dc.b $B0                ; DATA XREF: sub_12FDA↑r
                                        ; sub_12FDA+E↑w
                dc.b $87
byte_13416:     dc.b   0,  6            ; DATA XREF: ROM:000126A8↑w
                                        ; sub_12998+276↑r ...
byte_13418:     dc.b   0,$57,  0,  0,  0,  7,  7,  0
                                        ; DATA XREF: ROM:00012704↑w
                                        ; sub_1284C:loc_128F4↑r ...
                dc.b   7,  7,  0,$70,  0,$77,  7,$70
                dc.b   7,$77,$FF,$90,  0,  0,  0,  0
                dc.b   0,  0,  0,  0,  0,  0,  0,  0
byte_13438:     dc.b   0,$66,$F8,  0    ; DATA XREF: ROM:000126FC↑w
                                        ; sub_1284C+AE↑r ...
byte_1343C:     dc.b $FF,  0            ; DATA XREF: sub_12CF0+12↑w
                                        ; sub_12CF0+52↑r
byte_1343E:     dc.b   0,  0            ; DATA XREF: sub_12CF0+1A↑w
                                        ; sub_12CF0+26↑r
byte_13440:     dc.b   0,  0,  0,  0,  0,  0,  0,$A0
                                        ; DATA XREF: ROM:000125C6↑o
                                        ; sub_12D72+6↑o
                dc.b   0,  0,  1,$40,  0,  0,  1,$E0
                dc.b   0,  0,  2,$80,  0,  0,  3,$20
                dc.b   0,  0,  3,$C0,  0,  0,  4,$60
                dc.b   0,  0,  5,  0,  0,  0,  5,$A0
                dc.b   0,  0,  6,$40,  0,  0,  6,$E0
                dc.b   0,  0,  7,$80,  0,  0,  8,$20
                dc.b   0,  0,  8,$C0,  0,  0,  9,$60
                dc.b   0,  0, $A,  0,  0,  0, $A,$A0
                dc.b   0,  0, $B,$40,  0,  0, $B,$E0
                dc.b   0,  0, $C,$80,  0,  0, $D,$20
                dc.b   0,  0, $D,$C0,  0,  0, $E,$60
                dc.b   0,  0, $F,  0,  0,  0, $F,$A0
                dc.b   0,  0,$10,$40,  0,  0,$10,$E0
                dc.b   0,  0,$11,$80,  0,  0,$12,$20
                dc.b   0,  0,$12,$C0,  0,  0,$13,$60
                dc.b   0,  0,$14,  0,  0,  0,$14,$A0
                dc.b   0,  0,$15,$40,  0,  0,$15,$E0
                dc.b   0,  0,$16,$80,  0,  0,$17,$20
                dc.b   0,  0,$17,$C0,  0,  0,$18,$60
                dc.b   0,  0,$19,  0,  0,  0,$19,$A0
                dc.b   0,  0,$1A,$40,  0,  0,$1A,$E0
                dc.b   0,  0,$1B,$80,  0,  0,$1C,$20
                dc.b   0,  0,$1C,$C0,  0,  0,$1D,$60
                dc.b   0,  0,$1E,  0,  0,  0,$1E,$A0
                dc.b   0,  0,$1F,$40,  0,  0,$1F,$E0
                dc.b   0,  0,$20,$80,  0,  0,$21,$20
                dc.b   0,  0,$21,$C0,  0,  0,$22,$60
                dc.b   0,  0,$23,  0,  0,  0,$23,$A0
                dc.b   0,  0,$24,$40,  0,  0,$24,$E0
                dc.b   0,  0,$25,$80,  0,  0,$26,$20
                dc.b   0,  0,$26,$C0,  0,  0,$27,$60
                dc.b   0,  0,$28,  0,  0,  0,$28,$A0
                dc.b   0,  0,$29,$40,  0,  0,$29,$E0
                dc.b   0,  0,$2A,$80,  0,  0,$2B,$20
                dc.b   0,  0,$2B,$C0,  0,  0,$2C,$60
                dc.b   0,  0,$2D,  0,  0,  0,$2D,$A0
                dc.b   0,  0,$2E,$40,  0,  0,$2E,$E0
                dc.b   0,  0,$2F,$80,  0,  0,$30,$20
                dc.b   0,  0,$30,$C0,  0,  0,$31,$60
                dc.b   0,  0,$32,  0,  0,  0,$32,$A0
                dc.b   0,  0,$33,$40,  0,  0,$33,$E0
                dc.b   0,  0,$34,$80,  0,  0,$35,$20
                dc.b   0,  0,$35,$C0,  0,  0,$36,$60
                dc.b   0,  0,$37,  0,  0,  0,$37,$A0
                dc.b   0,  0,$38,$40,  0,  0,$38,$E0
                dc.b   0,  0,$39,$80,  0,  0,$3A,$20
                dc.b   0,  0,$3A,$C0,  0,  0,$3B,$60
                dc.b   0,  0,$3C,  0,  0,  0,$3C,$A0
                dc.b   0,  0,$3D,$40,  0,  0,$3D,$E0
                dc.b   0,  0,$3E,$80,  0,  0,$3F,$20
                dc.b   0,  0,$3F,$C0,  0,  0,$40,$60
                dc.b   0,  0,$41,  0,  0,  0,$41,$A0
                dc.b   0,  0,$42,$40,  0,  0,$42,$E0
                dc.b   0,  0,$43,$80,  0,  0,$44,$20
                dc.b   0,  0,$44,$C0,  0,  0,$45,$60
                dc.b   0,  0,$46,  0,  0,  0,$46,$A0
                dc.b   0,  0,$47,$40,  0,  0,$47,$E0
                dc.b   0,  0,$48,$80,  0,  0,$49,$20
                dc.b   0,  0,$49,$C0,  0,  0,$4A,$60
                dc.b   0,  0,$4B,  0,  0,  0,$4B,$A0
                dc.b   0,  0,$4C,$40,  0,  0,$4C,$E0
                dc.b   0,  0,$4D,$80,  0,  0,$4E,$20
                dc.b   0,  0,$4E,$C0,  0,  0,$4F,$60
                dc.b   0,  0,$50,  0,  0,  0,$50,$A0
                dc.b   0,  0,$51,$40,  0,  0,$51,$E0
                dc.b   0,  0,$52,$80,  0,  0,$53,$20
                dc.b   0,  0,$53,$C0,  0,  0,$54,$60
                dc.b   0,  0,$55,  0,  0,  0,$55,$A0
                dc.b   0,  0,$56,$40,  0,  0,$56,$E0
                dc.b   0,  0,$57,$80,  0,  0,$58,$20
                dc.b   0,  0,$58,$C0,  0,  0,$59,$60
                dc.b   0,  0,$5A,  0,  0,  0,$5A,$A0
                dc.b   0,  0,$5B,$40,  0,  0,$5B,$E0
                dc.b   0,  0,$5C,$80,  0,  0,$5D,$20
                dc.b   0,  0,$5D,$C0,  0,  0,$5E,$60
                dc.b   0,  0,$5F,  0,  0,  0,$5F,$A0
                dc.b   0,  0,$60,$40,  0,  0,$60,$E0
                dc.b   0,  0,$61,$80,  0,  0,$62,$20
                dc.b   0,  0,$62,$C0,  0,  0,$63,$60
                dc.b   0,  0,$64,  0,  0,  0,$64,$A0
                dc.b   0,  0,$65,$40,  0,  0,$65,$E0
                dc.b   0,  0,$66,$80,  0,  0,$67,$20
                dc.b   0,  0,$67,$C0,  0,  0,$68,$60
                dc.b   0,  0,$69,  0,  0,  0,$69,$A0
                dc.b   0,  0,$6A,$40,  0,  0,$6A,$E0
                dc.b   0,  0,$6B,$80,  0,  0,$6C,$20
                dc.b   0,  0,$6C,$C0,  0,  0,$6D,$60
                dc.b   0,  0,$6E,  0,  0,  0,$6E,$A0
                dc.b   0,  0,$6F,$40,  0,  0,$6F,$E0
                dc.b   0,  0,$70,$80,  0,  0,$71,$20
                dc.b   0,  0,$71,$C0,  0,  0,$72,$60
                dc.b   0,  0,$73,  0,  0,  0,$73,$A0
                dc.b   0,  0,$74,$40,  0,  0,$74,$E0
                dc.b   0,  0,$75,$80,  0,  0,$76,$20
                dc.b   0,  0,$76,$C0,  0,  0,$77,$60
                dc.b   0,  0,$78,  0,  0,  0,$78,$A0
                dc.b   0,  0,$79,$40,  0,  0,$79,$E0
                dc.b   0,  0,$7A,$80,  0,  0,$7B,$20
                dc.b   0,  0,$7B,$C0,  0,  0,$7C,$60
                dc.b   0,  0,$14,  8,  0,  0,$6D,$D0
                dc.b   0,  0,$14,$20,  0,  0,$37,$38
                dc.b   0,  0,$1E,$48,  0,  0,$14,$18
                dc.b   0,  0,$23,$30,  0,  0,$16,$B8
                dc.b   0,  0,$14,$18,  0,  0,$50,$90
                dc.b   0,  0,$50,$90,  0,  0,$14,$10
                dc.b   0,  0,$37,$38,  0,  0,$14,$10
                dc.b   0,  0,$14,  0,  0,  0,$37,$58
                dc.b   0,  0,$37,$38,  0,  0,$23,$40
                dc.b   0,  0,$23,$40,  0,  0,$23,$38
                dc.b   0,  0,$52,$80,  0,  0,$78,  0
                dc.b   0,  0,$3F,$E8,$FF,$FF,$FE, $C
                dc.b   0,  0, $F,$70,  0,  0,$14,$70
                dc.b   0,  0,$19,$70,  0,  0,$1E,$70
                dc.b   0,  0,$23,$70,  0,  0,$28,$70
                dc.b   0,  0,$2D,$70,  0,  0,$32,$70
                dc.b   0,  0,$37,$70,  0,  0,$3C,$70
                dc.b   0,  0,$41,$70,  0,  0,$46,$70
                dc.b   0,  0,$4B,$70,  0,  0,$50,$70
                dc.b   0,  0,$55,$70,  0,  0,$5A,$70
                dc.b   0,  0,$5F,$70,  0,  0,$64,$70
                dc.b   0,  0,$69,$70,  0,  0,$6E,$70
                dc.b   0,  0,$73,$70,  0,  0,$3E,$48
                dc.b   0,  0,$3F,$E8,$FF,$FF,$FE, $C
                dc.b   0,  0,$53,$28,  0,  0,$1E,$A8
                dc.b   0,  0,$1E,$D8,  0,  0,$1F,  0
                dc.b   0,  0,$53,$80,$FF,$FF,$FE, $C
                dc.b   0,  0,$53,$38,  0,  0,$2D,$B8
                dc.b   0,  0,$2D,$D8,  0,  0,$2D,$F0
                dc.b   0,  0,$53,$70,$FF,$FF,$FE, $C
                dc.b   0,  0,$53,$40,  0,  0,$3C,$C0
                dc.b   0,  0,$3C,$D8,  0,  0,$3C,$E8
                dc.b   0,  0,$53,$68,  0,  0,$69,$E8
                dc.b   0,  0,$69,$D8,  0,  0,$69,$C0
                dc.b $FF,$FF,$FE, $C,  0,  0,$69,$D8
                dc.b   0,  0,$69,$C0,  0,  0,$53,$48
                dc.b   0,  0,$41,$C8,  0,  0,$41,$D8
                dc.b   0,  0,$41,$E0,  0,  0,$53,$60
                dc.b   0,  0,$64,$E0,  0,  0,$64,$D8
                dc.b   0,  0,$64,$C8,  0,  0,$53,$48
                dc.b   0,  0,$46,$C8,  0,  0,$46,$D8
                dc.b   0,  0,$46,$E0,  0,  0,$53,$60
                dc.b   0,  0,$5F,$E0,  0,  0,$5F,$D8
                dc.b   0,  0,$5F,$C8,  0,  0,$53,$50
                dc.b   0,  0,$4B,$D0,  0,  0,$4B,$D8
                dc.b   0,  0,$4B,$D8,  0,  0,$53,$58
                dc.b   0,  0,$5A,$D8,  0,  0,$5A,$D8
                dc.b   0,  0,$5A,$D0,  0,  0,$53,$50
                dc.b   0,  0,$50,$D0,  0,  0,$50,$D8
                dc.b   0,  0,$50,$D8,  0,  0,$53,$58
                dc.b   0,  0,$55,$D8,  0,  0,$55,$D8
                dc.b   0,  0,$55,$D0,$FF,$FF,$FE, $C
                dc.b $FF,$FF,$FE, $C,  0,  0,  0,  0
                dc.b   0,  0,  0,  0,  0,  0,  0,  0
                dc.b   0,  0,  0,  0,  0,  0,  0,  0
                dc.b   0,  0,  0,  0,  0,  0,  0,  0
                dc.b   0,  0,  0,  0,  0,  0,  0,  0
