...
;---------------------------------------------------------------------------------
CheckCurrentScoreAgainstHighScore    BNE b10D6
                                     INY
                                     JMP UpdateHiScore

b10D6                                BMI SaveNewHiScore
                                     JMP DrawHiScoreAndWaitForFire

SaveNewHiScore                       JMP SaveHiScore

                                     .BYTE $01,$60
;-------------------------------------------------------------------------
; InitializeScreenAndBorder
;-------------------------------------------------------------------------
InitializeScreenAndBorder            LDA #$FF
...
;---------------------------------------------------------------------------------
ResetVariablesAndRestartLevel        LDA #$13
                                     STA oldYPos
                                     LDA #$0A
                                     STA oldXPos
                                     LDA #$00
...
; MainGameLoop
;---------------------------------------------------------------------------------
MainGameLoop                         JSR MaybeUpdateShipPosition
                                     JSR FireBullets
...
;-------------------------------------------------------------------------
GetScreenPointerForCurrentXYPos      LDA #>SCREEN_RAM
                                     STA screenRamHiPtr
                                     LDA #<SCREEN_RAM
                                     STA screenRamLoPtr
...
;-------------------------------------------------------------------------
DrawCurrentCharacterToScreen         TXA
                                     PHA
                                     TYA
                                     PHA
...
; UpdateShipPosition
;---------------------------------------------------------------------------------
UpdateShipPosition                   JSR GetJoystickInput
...
;-------------------------------------------------------------------------
MaybeUpdateShipPosition              DEC frameRateCounter
                                     BEQ b12F9
                                     RTS
...
; MaybeFireBullet
;---------------------------------------------------------------------------------
MaybeFireBullet                      LDA bulletActive
                                     BNE b1331
...
DrawBulletOverGrid                   LDA #BULLET_UP1
                                     STA (bulletScreenRamLoPtr),Y
                                     LDA bulletScreenRamHiPtr
                                     PHA
                                     CLC
...
; FireBullets
;-------------------------------------------------------------------------
FireBullets                          LDA frameRateCounter
                                     AND #$01
                                     BEQ b139D
                                     RTS

PlayBulletSoundAndFire               LDA VICCRD   ;$900D - frequency of sound osc.4 (noise)
                                     AND #$80
                                     BEQ JumpToMaybeFireBullet
                                     DEC VICCRD   ;$900D - frequency of sound osc.4 (noise)
JumpToMaybeFireBullet                JMP MaybeFireBullet
...
b13A2                                LDA #$22
                                     STA podUpdateInterval
                                     JMP PlayBulletSoundAndFire

;---------------------------------------------------------------------------------
; UpdateBulletPositionAndDraw
;---------------------------------------------------------------------------------
UpdateBulletPositionAndDraw          LDA bulletScreenRamLoPtr
                                     CMP #$FF
                                     BNE DrawBullet
...
;-------------------------------------------------------------------------
UpdateXYZappersPosition              LDA frameRateCounter
                                     CMP #$01
                                     BEQ b13BB
                                     RTS
...
;---------------------------------------------------------------------------------
MaybeFireBulletsAndLasers            JSR MaybeFireBullet
                                     JMP DrawLasers
...
; UpdatePods
;-------------------------------------------------------------------------
UpdatePods                           LDA podUpdateInterval
                                     CMP #$01
                                     BEQ b1508
                                     RTS
...
;-------------------------------------------------------------------------
CheckBulletCollisionWithPod          CMP #$00
...
; PlaySomeSounds
;---------------------------------------------------------------------------------
PlaySomeSounds                       LDA VICCRC   ;$900C - frequency of sound osc.3 (soprano)
                                     AND #$80
                                     BNE b1564
                                     RTS
...
; MaybePlaySomeSounds
;-------------------------------------------------------------------------
MaybePlaySomeSounds                  LDA podUpdateInterval
                                     CMP #$01
                                     BEQ PlaySomeSounds
                                     RTS
...
; UpdatePodDecayState
;-------------------------------------------------------------------------
UpdatePodDecayState                  LDA podDecayInterval
                                     CMP #$02
                                     BEQ b15AE
                                     RTS
...
; CheckPodDecayState
;-------------------------------------------------------------------------
CheckPodDecayState                   STX currentXLaserCharacter
                                     LDX #$06
...
;-------------------------------------------------------------------------
MaybeDrawFallingBombs                LDA podUpdateInterval
                                     CMP #$02
                                     BEQ b16A3
                                     RTS
...
BombHitTheShip                       JMP JumpToExplodeShip
...
; MaybeDrawDroids
;-------------------------------------------------------------------------
MaybeDrawDroids                      LDA frameRateCounter
                                     AND #$01
                                     BEQ DrawDroids
                                     RTS

DrawDroids                           DEC droidAnimationInterval
                                     JMP AnimateDroids

;---------------------------------------------------------------------------------
; DrawMovementofDroids
;---------------------------------------------------------------------------------
DrawMovementofDroids                 LDA #$A0
...
DrawDroidLoop                        LDA droidScreenLineLoPtr,X
                                     STA screenRamLoPtr
...
;---------------------------------------------------------------------------------
GetScreenRamPtrForNewPosition        LDY nextDroidPositionOffset
...
; DrawDroidAtPosition
;---------------------------------------------------------------------------------
DrawDroidAtPosition                  LDA currentDroidCharacter
                                     LDY #$00
                                     STA (screenRamLoPtr),Y
                                     LDA screenRamHiPtr
                                     STA droidScreenLineHiPtr,X
...
;-------------------------------------------------------------------------
CalculateDroidPosition               LDA droidDirectionBitMap,X
                                     AND #$01
                                     BEQ b1827
                                     INC screenRamLoPtr
                                     BNE b1822
...
; AnimateDroids
;---------------------------------------------------------------------------------
AnimateDroids                        LDA droidAnimationInterval
                                     BEQ b185F
                                     RTS
...
;---------------------------------------------------------------------------------
CheckIfBulletHitsDroid               DEC unusedVariable
                                     LDA droidsLeftToKill
                                     CMP #$01
                                     BNE b190D
                                     LDA droidDirectionBitMap,X
...
DroidHit                             ; Draw a pod where the droid was hit and increment the score.
...
;---------------------------------------------------------------------------------
RefillDroidsIfNecessary              LDA droidsLeftToKill
                                     CLC
                                     ASL
                                     CLC
                                     ADC droidsLeftToKill
...
;---------------------------------------------------------------------------------
CheckIfBulletCollidedWithDroid       LDA (bulletScreenRamLoPtr),Y
                                     CMP #DROID1
...
BulletCollidedWithDroid              JMP DestroyDroid
...
; CheckForBullets
;---------------------------------------------------------------------------------
CheckForBullets                      LDA droidDirectionBitMap,X
                                     AND #$C0
                                     BNE b1935
                                     TXA
                                     PHA
...
;-------------------------------------------------------------------------
CheckIfBumpingAgainstSomething       CMP #$13
                                     BEQ b1A08
                                     CMP #$14
                                     BEQ b1A08
                                     CMP #$15
...
; JumpToExplodeShip
;---------------------------------------------------------------------------------
JumpToExplodeShip                    JMP ExplodeShip

;-------------------------------------------------------------------------
; CheckForCollisionWithShip
;-------------------------------------------------------------------------
CheckForCollisionWithShip            LDY #$00
                                     LDA (screenRamLoPtr),Y
                                     CMP #SHIP
                                     BEQ b1A08
                                     LDA (screenRamLoPtr),Y
...
;-------------------------------------------------------------------------
ClearScreenDecrementLives            ; Clear Screen
                                     LDY #$00
                                     LDA #$20
...
;---------------------------------------------------------------------------------
DrawLivesLeftAndEnterNextLevel       LDY #$04
...
; LoadDataForLevel
;-------------------------------------------------------------------------
LoadDataForLevel                     LDY currentLevel
...
; PlayerKilled
;---------------------------------------------------------------------------------
PlayerKilled                         JSR ClearScreenDecrementLives
                                     LDA livesLeft
                                     BEQ b1BA7
...
; DrawTitleScreen
;-------------------------------------------------------------------------
DrawTitleScreen                      JSR InitializeScreenAndBorder
b1BA7                                LDA #$02
...
;---------------------------------------------------------------------------------
DrawHiScoreAndWaitForFire            LDY #$0A
...
sizeOfDroidSquadsForLevels=*-$01
                                     ...
                                     .BYTE  $82,$82,$82,$FE,$00,$08,$08,$00
                                     .BYTE  $08
;---------------------------------------------------------------------------------
; IncrementLevel
;---------------------------------------------------------------------------------
IncrementLevel                       INC currentLevel
                                     LDA currentLevel
                                     CMP #$14
                                     BNE b1D96
                                     DEC currentLevel
...
; CheckLevelComplete
;-------------------------------------------------------------------------
CheckLevelComplete                   LDA droidsLeftToKill
                                     BEQ b1DBA
                                     RTS
...
; LevelCleared
;---------------------------------------------------------------------------------
LevelCleared                         STA SCREEN_RAM + $012C,Y
                                     DEY
                                     BNE b1D9A
...
; IncrementLives
;-------------------------------------------------------------------------
IncrementLives                       JSR PlayASound2
                                     LDA #$00
                                     STA VICCRD   ;$900D - frequency of sound osc.4 (noise)
                                     INC livesLeft
                                     LDA livesLeft
